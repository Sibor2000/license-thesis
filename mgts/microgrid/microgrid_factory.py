...
class MicrogridFactory:
    ...
    @staticmethod
    def create_from_dataframe(df:pd.DataFrame, microgrid_id=None, produced_energy_column="produce", consumed_energy_column="consume") -> Microgrid:
    ...
    def create_from_sheet(self, sheet_name:str, microgrid_id=None, produced_energy_column="produce", consumed_energy_column="consume") -> Microgrid:
